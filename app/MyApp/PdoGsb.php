...
*/
	...
	/**
     * Retourne les mois validés (idEtat = 'VA') pour un visiteur
     * @param $idVisiteur
     * @return array
     */
    public function getLesMoisValides($idVisiteur){
    ...
    /**
     * Retourne la liste de tous les visiteurs (id, nom, prenom)
     * @return array
     */
    public function getLesVisiteurs(){
        $req = "select id, nom, prenom from visiteur order by nom, prenom";
        $res = $this->monPdo->query($req);
        return $res->fetchAll();
    }
